...
set_env_arg DB_HOSTNAME ${PROPERTIES_FILE}

set_env_arg DB_PORT ${PROPERTIES_FILE}

set_env_arg DB_SERVICENAME ${PROPERTIES_FILE}

set_env_arg USER_PUBLIC_PASSWORD ${PROPERTIES_FILE}

set_env_arg SYS_USER ${PROPERTIES_FILE}

set_env_arg SYS_PASSWORD ${PROPERTIES_FILE}

set_env_arg JAVA_OPTIONS ${PROPERTIES_FILE}

set_env_arg CLUSTER_ADDRESS ${PROPERTIES_FILE}
